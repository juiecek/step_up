...
{
    /// <inheritdoc />
    public partial class RemoveSpecialtyFromInstructor : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleDanceStyles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduleDanceStyles_DanceStyles_DanceStyleId",
                        column: x => x.DanceStyleId,
                        principalTable: "DanceStyles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleDanceStyles_Schedule_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedule",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleDanceStyles_DanceStyleId",
                table: "ScheduleDanceStyles",
                column: "DanceStyleId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleDanceStyles_ScheduleId",
                table: "ScheduleDanceStyles",
                column: "ScheduleId");
        }
